...
%F77% /fpp %FDEF% /define:_%COMPCODE%_ /I..\crystals ..\bits\shelx2cry\shelx2cry.F90 crystal_data.obj shelx2cry_cif.obj shelx_procedures.obj shelx2cry_dict.obj shelx2cry_mod.obj sginfo.lib %BITS_FOPTS%  /exe:shelx2cry.exe
